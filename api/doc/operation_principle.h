...
includes opening librares with \ref API_Open "API_Open()" function.
...
@subsection periodic_application_callback_function Periodic Application \
Callback Function
...
"lib_system->setPeriodicCb" "requesting periodic execution" for more information
on how this is done with API services.
...
scheduling. See also @ref execution_time_limits "guidance on maximum execution
time limits".
...
app_lib_system_exit_critical_section_f "lib_system->exitCriticalSection"</code>.
...
<tr><td>Deferred interrupt</td><td>100 us</td></tr>
