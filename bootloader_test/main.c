...
/**
 * \brief   Test app entrypoint from bootloader
 */
void __attribute__ ((noreturn, section (".entrypoint"))) entrypoint(bl_interface_t * interface)
{
    ...
    Print_printf("\n\n #######################################\n");
    Print_printf(    " #                                     #\n");
    Print_printf(    " #      Starting bootlodaer tests      #\n");
    Print_printf(    " #                                     #\n");
    Print_printf(    " #######################################\n\n");
