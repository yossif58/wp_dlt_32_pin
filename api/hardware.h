...
/**
 * Hardware peripherals to reserve. Not all platforms have all peripherals
 * available.
 */
typedef enum
{
...
/**
 * Hardware peripherals to activate. Not all platforms have all peripherals
 * available.
 */
typedef enum
{
...
/**
 * Ask the last read supply voltage value from the stack. The returned value is
 * in millivolts.
 *
