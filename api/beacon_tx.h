 ...
 * e.g.  on  the  sub-GHz architectures.
 *
 ...
 * app_lib_beacon_tx_set_beacon_channels_f , to select which advertising
 * channels are used for sending the beacon payload.
 */
typedef enum
{
 ...
 *          pointed by power_p is modified to the used value
 */
typedef app_res_e
